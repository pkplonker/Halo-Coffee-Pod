...
namespace UI
{
	public class Settings : MonoBehaviour
	{
		...
		public void SetSFXVolume(float volume) => audioMixer.SetFloat("SFXVol", Mathf.Log10(volume) * 20);


		public void SetMusicVolume(float volume) => audioMixer.SetFloat("MusicVol", Mathf.Log10(volume) * 20);
	}
}